...
<script>
    ...
    function getYearInfo() {
        var url = "https://csa-backend.rohanj.dev/calendar1/yearInfo/" + document.getElementById("year1").value;
    ...
    function getDayInfo() {
        var url = "https://csa-backend.rohanj.dev/calendar1/dayInfo/" + document.getElementById("day").value;
    ...
    function getLeapYears() {
        var url = "https://csa-backend.rohanj.dev/calendar1/leapYears/" + document.getElementById("year1").value + "/" + document.getElementById("year2").value;
    ...
    function getYearFact() {
        var url = "https://csa-backend.rohanj.dev/calendar2/" + document.getElementById("year1").value;
